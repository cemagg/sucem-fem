...
from NewCode.ImplicitExplicit import NewmarkCoupledHybridSystem
...
class TestRun(Runners.TestRun):
    ...
    useLU = True
    SystemClass = NewmarkCoupledHybridSystem.NewmarkCoupledHybridSystem
...
pickle.dump(resses, file('+newmark_leapfrog_hybrid_tmp.pickle', 'w'))
