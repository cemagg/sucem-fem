...
#results = pickle.load(file('+coupledb_results_1st.pickle'))
#results = pickle.load(file('+newmark_results.pickle'))
#resfiles = (#'../working/+newmark_results_1st_beta0.3.pickle',
            #'../working/+newmark_results_2nd_beta0.3.pickle',
            #'../working/+newmark_results_3rd_beta0.3.pickle',
            #'../working/+newmark_results_4th_dt0.015635_new_beta0.3.pickle',
            #'../working/+newmark_results_4th_beta0.3.pickle',
#            )
resfiles = (
#    '+coupledb_results_o_4_dt_0.03125_t_40000.pickle',
     '+coupledb_results_1st_subset.pickle',
#     '+coupledb_results_2nd_real.pickle',
#     '+coupledb_results_3rd_dt0.015625.pickle',
#     '+coupledb_results_3rd_dt0.03125.pickle',
#     '+coupledb_results_3rd_initial_dts_only.pickle',
#     '+coupledb_results_o_4_dt_0.015625_t_10000.pickle',
#     '+coupledb_results_o_4_dt_0.015625_t_20000.pickle',
#     '+coupledb_results_o_4_dt_0.015625_t_2500.pickle',
#     '+coupledb_results_o_4_dt_0.015625_t_40000.pickle',
#     '+coupledb_results_o_4_dt_0.015625_t_5000.pickle',
#     '+coupledb_results_o_4_dt_0.015625_t_80000.pickle',
#     '+coupledb_results_o_4_dt_0.0384_t_10000.pickle',
#     '+coupledb_results_o_4_dt_0.0384_t_160000.pickle',
#     '+coupledb_results_o_4_dt_0.0384_t_20000.pickle',
#     '+coupledb_results_o_4_dt_0.0384_t_2500.pickle',
#     '+coupledb_results_o_4_dt_0.0384_t_40000.pickle',
#     '+coupledb_results_o_4_dt_0.0384_t_5000.pickle',
#     '+coupledb_results_o_4_dt_0.0384_t_80000.pickle',
)

#for order in [1]:#(1,2,3,4):

#analysis = pickle.load(file('+coupledb_fft_analysis_no1st.pickle'))
...
for rfile in resfiles:
    ...
    try:
        ...
        pickle.dump(analysis, file('+coupledb_fft_analysis_emergency.pickle', 'w'))
        raise

pickle.dump(analysis, file('+coupledb_fft_analysis_new.pickle', 'w'))
