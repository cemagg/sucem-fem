...
class TestRun(Runners.TestRun):
    ...
    useLU = True
    SystemClass = HybridMeshNewmarkCoupledHybridSystem
    drive_group = 'e'
    log_group = 'e'
    def __init__(self, tet_mesh, brick_mesh, BCs, on_hbdry, order, **kwargs):
        self.system = self.SystemClass(tet_mesh, brick_mesh, **kwargs)
        self.system.useLU = self.useLU
        self.system.init_group_freefuns(on_hbdry, BCs)
...
pickle.dump(resses, file('+newmark_leapfrog_hybrid_hybmesh-tmp.pickle', 'w'))
