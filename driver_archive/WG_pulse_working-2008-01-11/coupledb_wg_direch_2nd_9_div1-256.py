...
extra_meshfilename =  'waveguide1x0.25x5.1-9.femmesh',
run_label(1) = '  ', 
...
dt_divisors = (256,128,64,32,16,13)
resses = {}
for order in orders:
...
pickle.dump(resses, file('+coupledb_wg_direch_2nd_9_div1-256_newBCs.pickle', 'w'))
